    ...
    server: {
        ...
        api_access: {
            ...
            authenticated: [
                ...
                '/api/cla/getLastSignature',
                '/api/cla/countCLA',
                '/api/cla/getDistinctClas',
                '/api/cla/validateOrgPullRequests',
                '/api/cla/validatePullRequest',
                '/api/cla/validateAllPullRequests',
                '/api/cla/validateSharedGistItems',
                '/api/cla/sign',
                '/api/cla/check',
                '/api/cla/revoke',
                '/api/github/call',
                '/api/org/getForUser',
                '/api/org/getGHOrgsForUser',
                '/api/repo/check',
                '/api/repo/getAll',
                '/api/webhook/get',
                '/api/webhook/create',
